...
//! [`MmFamilyProcessor`] (see `family.rs`). Families produce data; they
//! cannot alter orchestration.

use rayon::prelude::*;

use crate::common::{self, fetch, tokens};
use crate::family::{DecodedMedia, MmFamilyProcessor, PositionOutput, ProcessedItem};
...
pub struct OutputItem {
    pub feature: crate::family::Tensor,
    pub aux: crate::family::NamedTensors,
    ...
    /// here vs SHA-256 there): hashes are consistent within the native path,
...
mod tests {
    ...
    fn processes_typed_image_request() {
        ...
        let crate::family::PositionOutput::MRope { positions, .. } = &out.positions else {
