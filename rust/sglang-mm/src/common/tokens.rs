//! Token-layout mechanics for the native MM path.
//!
//! Families describe their prompt geometry as a [`TokenLayout`] value
//! (`family.rs`); [`apply_layout`] applies it mechanically. Expanding the
...
use crate::family::{Segment, TokenLayout, TokenPattern};
